...
The 36 versioned fixtures in `evaluation/fixtures/yoruba-failed-transfer.v0.1.mts` provide synthetic text ground truth across Yoruba-heavy, Yoruba-English, Yoruba-Pidgin, and Nigerian English slices. They include intent, entity, missing-field, clarification, confirmation, task-result, and safety expectations. They are not audio samples, provider results, or measured benchmark scores, and their language annotations require qualified speaker review. Future scoring must keep transcription, intent, entity/slot, clarification/confirmation behavior, and downstream task success separate.
